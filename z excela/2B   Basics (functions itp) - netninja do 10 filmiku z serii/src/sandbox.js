...
var wynik = minus(10, 20); //wynik od razu tez ma typowana wartosc, przypisana do typu jaka zwracana jest w minusie.
wynik = 5; // ok, ale..
...
logDetails = function (ninja) {
    console.log("".concat(ninja.name, " is ").concat(ninja.age, " years old")); //ten ninja wcale nie jest potrzebny,ale przez to mozemy sie odwolywac latwiej do parametrow
};
var test1 = logDetails({ name: "Riu", age: 24 });
console.log(test1);
//ale to samo mozna zrobic tez z aliasem np.
var logDetails2;
logDetails2 = function (ninja) {
    console.log("Sensej ".concat(ninja.name, "-san ma ").concat(ninja.age, " lat"));
};
