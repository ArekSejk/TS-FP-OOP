...
exports.SzablonListy = void 0;
var SzablonListy = /** @class */ (function () {
    function SzablonListy(container) {
        this.container = container;
    } //tu cont, ktory podaje przy submitowaniu bedzie UL
    SzablonListy.prototype.render = function (dokument, naglowek, pos) {
        var li = document.createElement('li'); //tworze li.
        var h4 = document.createElement('h4'); //tworze naglowek wpisu
        h4.innerText = naglowek; //wstawiam do neigo tresc
        li.append(h4); //wstawiam naglowek li;(apend tzn na koniec)
        var p = document.createElement('p'); //tworze tresc do wpisu
...
exports.SzablonListy = SzablonListy;
