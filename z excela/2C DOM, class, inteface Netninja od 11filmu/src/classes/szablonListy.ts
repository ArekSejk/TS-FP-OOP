...
export class SzablonListy {
    constructor(private container: HTMLUListElement) {}             //tu cont, ktory podaje przy submitowaniu bedzie UL

    render(dokument: hasFormatter, naglowek: string, pos: 'start' | 'end') {        //tworze elementy na liscie w html
